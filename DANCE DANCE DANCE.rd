...
class GoPiGo3WithKeyboard(object):
    ...
    def __init__(self):
        ...
        "4" : ["Turn ON/OFF Turn Signal", "turnsignal"],
        ...
        self.order_of_keys = ["w", "s", "a", "d", "<SPACE>", "<F1>", "<F2>", "<F3>", "1", "2", "3", "4", "8", "9", "0", "e", "k", "<ESC>" ]
    ...
    def drawLogo(self):
        ...
        print("|    // _ \/ _` | | ___ \/ _ \/ _` | '_ \ ")
        print("| |\ \  __/ (_| | | |_/ /  __/ (_| | | | | ")
        print("\_| \_\___|\__,_| \____/ \___|\__,_|_| |_| ")
        print("                                              ")
        print("___  ___           _     _  ")
        print("|  \/  |          | |   (_) ")
        print("| .  . | ___   ___| |__  _  ")
    ...
    def mySPIN1function(self):
        b = 60/128
        self.gopigo3.spin_left()
        sleep(4*b)
        self.gopigo3.spin_right()
        sleep(4*b)
    def mySPIN2function(self):
        b = 60/128
        self.gopigo3.spin_right()
        sleep(4*b)
        self.gopigo3.spin_left()
        sleep(4*b)
    def mySTEERfunction(self):
        b = 60/128
    ...
    def _gopigo3_command_danceOff(self):
        ...
        sleep(8*b)
        self.mySPIN2function()
        self.mySTEERfunction()
        self.mySTEERfunction()
        self.gopigo3.steer(100, 0)
        sleep(2*b)
        #go back to the middle
        self.mySTEERfunction()
        self.gopigo3.steer(20, 10)
        time.sleep(2*b)
        self.gopigo3.stop() 
        time.sleep(4*b)
        #Part 2 starts at 31s
        self.gopigo3.forward()
        time.sleep(2*b)
        self.gopigo3.backward()
        time.sleep(2*b)
        self.gopigo3.steer(80, 0)
        time.sleep(2*b)
        self.gopigo3.steer(0, 100)
        time.sleep(2*b)
        self.gopigo3.backward()
    ...
    def _gopigo3_command_turnsignal(self):
        print("TurnSignalEngaged!")
